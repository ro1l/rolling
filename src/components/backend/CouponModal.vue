                ...
                <div class="card border-lg border-end border-black px-2 py-4">
                  ...
                  <div class="card-body">
                    <div class="mb-4">
                      ...
                      placeholder="請輸入名稱" aria-label="example"
                    ...
                    <div class="mb-4">
                      ...
                      <input class="form-control border-dark rounded-0
                      border-1 bg-transparent p-3" type="text"
                      placeholder="請輸入code" aria-label="example"
                    ...
                    <div class="mb-4">
                      ...
                      placeholder="請輸入百分比" aria-label="example"
                    ...
                    <div class="mb-4">
                      ...
                      placeholder="請輸入期限" aria-label="example"
                        v-model="due_date">
                    </div>
                  </div>
                </div>
