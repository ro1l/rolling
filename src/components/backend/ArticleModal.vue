            ...
            <div class="row p-0">
              ...
              <div class="col-12">
                <div class="card border-lg border-bottom border-black px-2 py-4">
                  ...
                  <div class="card-body
                  w-100">
                    <Editor api-key="v9qd6mo7pj1ij6ci3z7691b9kd3fjj2bc9km9xgru539dsyt" :init="{
                      menubar: false,
                      plugins: [
                      ],
                      toolbar_mode: 'wrap',
                ...
                <div class="card border-lg border-bottom border-black px-2 py-4">
                  ...
                  d-flex justify-content-center align-items-center">
                    <label class="cursor-pointer preview" for="customFile">
                      ...
                      align-items-center position-relative" v-if="tempArticle.image !== undefined">
                ...
                <div class="card border-lg px-2 py-4">
                  ...
                  <div class="card-body">
                    ...
                    px-5 pt-5">
                      ...
                      name="select" id="true" checked :value="true"
                      ...
                      name="select" id="false" :value="false"
                        v-model="tempArticle.isPublic">
                ...
                <div class="card border-lg border-start border-black px-2 py-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-4">
                      ...
                      <input class="form-control border-dark rounded-0
                      border-1 bg-transparent p-3" type="date"
                      aria-label="example" v-model="create_at">
                    </div>
                  </div>
                </div>
              </div>
